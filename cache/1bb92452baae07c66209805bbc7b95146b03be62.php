                ...
                <main class="main_content">
                    ...
                    <div class="post">
                        <label for="single_post_link">
                            <img class="post__image"  src="<?php echo e($post->getImage()); ?>" alt=""></label>
                        <div class="post__title" id="single_post_link">
                            <a href="/single/<?php echo e($post->id); ?>"><?php echo e($post->title); ?></a>
                        </div>
                        ...
                        <?php echo e($post->content); ?>
                            ...
                            <div class="post__component"><span>Категории:</span>
                                <?php if(!empty($post->categories()->get())): ?>
...
<?php echo $__env->make('main.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first_mvc/views/main/select.blade.php ENDPATH**/ ?>